...
export const EN: Readonly<Record<Phrase, string>> = {
  ...
  deliveries_waiting_to_send: "hand-overs still on this phone. They go by themselves.",
...
export const HA: Readonly<Record<Phrase, string>> = {
  ...
  deliveries_waiting_to_send: "mika kaya na nan a wayar. Za su tafi da kansu.",
...
export const YO: Readonly<Record<Phrase, string>> = {
  ...
  deliveries_waiting_to_send: "ìfilọ́wọ́ tí ó ṣì wà lórí fóònù yìí. Wọ́n á lọ fúnra wọn.",
...
export const IG: Readonly<Record<Phrase, string>> = {
  ...
  deliveries_waiting_to_send: "nnyefe ka dị na ekwentị a. Ha ga-aga n'onwe ha.",
